...
// `getModelInfo` was removed in Task 8. The provider-specific id pattern
// helpers it returned (isOpenAIGPT5, isOpenAIOSeries, isAnthropicThinkingModel,
// isAnthropicAdaptiveThinkingModel) now live in
// `src/modelManagement/providers/adapters/adapterUtils.ts` and are tested by
// `adapterUtils.test.ts`.
